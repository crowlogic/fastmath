                                   ...
                                   Serializable
{
  ...
  public DoubleMatrix ldivide(DoubleMatrix B, VectorContainer container) throws SingularFactorException,
                                                                         IllegalValueError
  {
  ...
  public AbstractMatrix mlag(int k)
  {
    ...
    DoubleColMatrix y = new DoubleColMatrix(this.getRowCount(),
                                            this.getColCount() * k);
    int idx = 0;
  ...
  public AbstractMatrix qr(DoubleMatrix q)
  {
    ...
    {
      this.allocateWorkspace(1);
      DoubleMatrix.dgeqp3(this.getRowCount(),
                          this.getColCount(),
                          this.getBuffer(),
                          this.getOffset(0, 0),
                          this.getRowCount(),
                          ...
                          tau.getBuffer(),
                          tau.getOffset(0),
                          this.workspace.getBuffer(),
                          -1);
      this.optimalQRWorkspace = (int) this.workspace.get(0);
    }
    this.allocateWorkspace(this.optimalQRWorkspace);
    int ret = DoubleMatrix.dgeqp3(this.getRowCount(),
                                  this.getColCount(),
                                  this.getBuffer(),
                                  this.getOffset(0, 0),
                                  this.isTranspose() ? this.getColCount() : this.getRowCount(),
                                  jpvt.getBuffer(),
                                  tau.getBuffer(),
                                  tau.getOffset(0),
                                  this.workspace.getBuffer(),
    ...
    if (q != null)
    {
      ...
      ret = DoubleMatrix.dorgqr(q.getRowCount(),
                                q.getColCount(),
                                tau.size(),
                                q.getBuffer(),
                                q.getOffset(0, 0),
